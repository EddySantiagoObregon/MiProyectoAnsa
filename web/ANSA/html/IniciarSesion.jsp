        ...
        <main>
            ...
            <input type="hidden" name="accion" id="accion" value="IniciarSesion">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th colspan="2" style="text-align: center; margin-left: 10px"> INICIO DE SESIÓN</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="negrita">Login</td>
                            <td>
                             <input type="text" required="required" class="form-control" id="txtLogin" name="txtLogin" value="" placeholder="Login" autocomplete="off"/>
                            </td>
                        ...
                        <tr>
                            <td>Password</td>
                            <td class="negrita">
                              <input type="password" required="required" class="form-control" id="txtPassword" name="txtPassword" value="" placeholder="Password" autocomplete="off"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"  style="text-align: center">
                                <input type="submit" value="Ingresar" name="btnIniciarSesion" id="btnIniciarSesion" class="btn btn-dark"/>
