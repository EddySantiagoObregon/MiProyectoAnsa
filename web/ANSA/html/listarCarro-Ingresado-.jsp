...
<html>
    ...
    <div class="contenedor">
        <h1 style="cursor: pointer;" onclick="window.location='ComprarVehiculo-ingresado-.jsp'" class="icon-cab">ANSA</h1>
...
<table border="1">
        ...
        %>
        <tr>
            <td><%= rs.getString("carPlaca") %></td>
            <td><%= rs.getString("carLinea") %></td>
            ...
            <td><%= rs.getString("carDispoible") %></td>
            <td><%= rs.getString("TipoVehiculo") %></td>
            <td><%= rs.getString("Marca") %></td>
            <td><%= rs.getString("nombreCiudad") %></td>
            <td> <button type="button" class="btn btn-dark">Contactar vendedor</button></td>
