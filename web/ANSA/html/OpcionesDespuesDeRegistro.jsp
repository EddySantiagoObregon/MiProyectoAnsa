<%-- 
    Document   : OpcionesDespuesDeRegistro
    Created on : 26/10/2019, 03:08:21 PM
    Author     : Usuario
--%>
...
<h1 style="cursor: pointer;" onclick="location.href='ComprarVehiculo-ingresado-.jsp'" class="icon-cab">ANSA</h1>
        ...
        <main>
            ...
            <section id="bienvenidos">
                ...
                <div class="contenedor">
                    <div class="info-pet">
                        <img onclick="location.href='ComprarVehiculo-ingresado-.jsp'" src="../imagenes/OpcionesDespuesDeRegistro/Compra.jpg" alt="">
                        <h4 onclick="location.href='ComprarVehiculo-ingresado-.jsp'">Comprar un usado</h4>
                    </div>
                    <div class="info-pet">
                        <img onclick="location.href='AgregarVehiculo.jsp'" src="../imagenes/OpcionesDespuesDeRegistro/Publica.jpg" alt="">
                        <h4 onclick="location.href='AgregarVehiculo.jsp'">Publicar tú usado</h4>
                    </div>
           ...
           <div id="mensaje" style="text-align: center">
            ...
            <section id="info">
                ...
                <a href="ComprarVehiculo-ingresado-.jsp"></a>
            </section>
        </main>
