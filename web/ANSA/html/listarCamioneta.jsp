<%-- 
    Document   : Pagina
    Created on : 26/10/2019, 03:56:16 PM
    Author     : Usuario
--%>
...
<html>
    ...
    <body>
                 <script>
    function alerta(){
        alert("Primero te debes registrar para publicar tu vehículo usado!")
    }
      function alertaa(){
     ...
     <div class="contenedor">
        <h1 style="cursor: pointer;" onclick="location.href='Pagina.jsp'" class="icon-cab">ANSA</h1>
        <input type="checkbox" id="menu-bar">
        <label class="fontawesome-align-justify" for="menu-bar"></label>
                <nav class="menu">
                    <a href="IniciarSesion.jsp">Iniciar sesión</a>
                    <a href="AgregarPersona.jsp">Registrarce</a>
                    <input onclick="alerta()" type="button" value="Publica tu usado" class="btn btn-dark">
                    <a href="listarCarro.jsp">Carros</a>
                    <a href="listarCamioneta.jsp">Camionetas</a>
        ...
        <main>
            ...
            <div class="contenedor">
                ...
                <p>Encontras tu choche ideal , tenemos gamas bajas,medias y altas para que todo se acomode a tu bolsillo , encuentra tu auto favorito y vive una experiencia inolvidable</p>
                </div>
            </section>
...
ResultSet rs;
ps=conexion.prepareStatement("select carro.*, tipovehiculo.*, carromarca.*, ciudad.*"
               ...
               + " inner join ciudad on carro.carCiudad=ciudad.idCiudad where carro.carTipoVehiculo=2");
rs=ps.executeQuery();
%> 
    ...
    <center>     
        ...
        <tr>
           ...
           <th>Marca</th>
                    ...
                    <th>Tipo Vehiculo</th>
                     <th>Ubicación</th>
                    <th>Contactar con el vendedor</th>
        </tr>
        <% 
        while(rs.next()){
        %>
        <tr>
            <td><img width="150" height="100" src="../imagenes/fotoModelo/fotoModelo.jpg" alt=""/></td>
            
            <td> <%= rs.getString("Marca") %> <%= rs.getString("carLinea") %> </td>
            <td><%= rs.getString("carAnio") %></td>
            <td><%= rs.getString("carKilometraje") %></td>
            <td><%= rs.getString("carCilindraje") %></td>
            <td><%= rs.getString("carPrecio") %></td>
            <td><%= rs.getString("carTipoCaja") %></td>
            <td><%= rs.getString("carDescripcion") %></td>
          
            <td><%= rs.getString("TipoVehiculo") %></td>
            
            <td><%= rs.getString("nombreCiudad") %></td>
            <td> <button onclick="alertaa()" type="button" class="btn btn-dark">Contactar vendedor</button></td>
            ...
            <section id="info">
                ...
                <div class="contenedor">
                    ...
                    <div class="info-pet">
                                 ...
                                 <img src="https://i.ytimg.com/vi/qRDiTl7nWCs/maxresdefault.jpg" alt="">
                        <h4>Alta</h4>
                    </div> 
