     ...
     <div class="contenedor">
        ...
        <table style="witdth:50%" border="1" align="center" class="table table-bordered">
            <thead aling="center">
                            ...
                            <tr>
                                <th  colspan="2" style="text-align: center; margin-left: 10px"> Registrarse </th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <tr>
                       ...
                       <td><input type="number" name="txt_Documento" id="txtidentificacion" class="form-control " value="" required/></td>
                    ...
                    <tr>
                        <td class="negrita"><font color="black">Nombres</font></td>
                         <td><input type="text" name="txt_Nombre"  id="txt_Nombre" class="form-control" value="" required/></td>
                    </tr>
                    <tr>
                        <td class="negrita"><font color="black">Apellidos</font></td>
                      <td><input type="text" name="txt_Apellido"  id="txt_Apellido" class="form-control" value="" required/></td>  
                    </tr>
                
                    <tr>
                        <td class="negrita"><font color="black">Telefono</font></td>
                        <td><input type="number" name="txt_Telefono" id="txt_Telefono" class="form-control"  value="" required/></td>
                    </tr>
                     <tr>
                        <td class="negrita"><font color="black">Correo</font></td>
                        <td><input type="email" name="txt_Correo" id="txt_Correo" class="form-control"  value="" required/></td>
                    </tr>
                     <tr>
                        <td class="negrita"><font color="black">Contraseña</font></td>
                        <td><input type="password" name="txt_Contraseña" id="txt_Contraseña" class="form-control"  value="" required/></td>
                    </tr>
                    <tr>
                        <td colspan="2"  style="text-align: center; margin-left: 10px">
                            <input   id="btnAgregar" type="button" value="Registrarse" name="btnAgregar" class="btn btn-dark ">
